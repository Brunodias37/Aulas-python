...
print("\n Utilizando o np.array: ", lista)
#-------------------------------------------------------------------------

mat1d = np.arange(10)
print("\n Utilizando o np.arrange para gerar um array com o numero de posições indicadas: ", mat1d)
#-------------------------------------------------------------------------

x = np.array([1,2,3,4,5])
print("\n Criando um array com valores pré determinados: ", x)
#-------------------------------------------------------------------------

impar = mat1d[mat1d % 2 == 1]
print("\n Filtrando todos os valores impares do array ", impar)
#-------------------------------------------------------------------------

#arange(valor_inicial, valor_final, intervalo)
mat1d_seg = np.arange(5,11)
print("gerando um array com np.range indicando valor inicial e final: ", mat1d_seg)
#-------------------------------------------------------------------------
...
print('Três primeiros elementos de vetA: ', vetA[0:3])
#-------------------------------------------------------------------------

print('\ntodos os valores após o Quinto elementos de vetA: ', vetA[5:] )
#-------------------------------------------------------------------------

print('\nOs três ultimos valores de vetA: ',vetA[-3:])
#-------------------------------------------------------------------------
